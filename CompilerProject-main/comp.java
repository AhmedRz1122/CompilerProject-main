...
public class comp {
    ...
    private static String stringLiteral = "\"[a-zA-Z0-9 ]*\"";  // New rule for string literals
    ...
    private static String filename = "C:\\Users\\hp\\Desktop\\CompilerProject-main\\CompilerProject-main\\test1.txt";
        ...
        try {
            ...
            for (String line : fileLines) {
                ...
                for (String lexeme : lexemes) {
                    ...
                    tokens.add(new Token(tokenCategory, lexeme));
